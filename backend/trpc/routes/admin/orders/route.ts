...
export const assignOrderProcedure = protectedProcedure
  ...
  .mutation(async ({ input }: { input: { orderId: string; driverId: string; driverName: string } }) => {
...
export const cancelOrderProcedure = protectedProcedure
  ...
  .mutation(async ({ input }: { input: { orderId: string; reason: string } }) => {
    // Mock implementation - replace with actual database update
...
export const sendSTKPushProcedure = protectedProcedure
  ...
  .mutation(async ({ input }: { input: { orderId: string } }) => {
