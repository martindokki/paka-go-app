      ...
      {showSearch && (
        <View style={styles.searchContainer}>
          <View style={[styles.searchBar, searchFocused && styles.searchBarFocused]}>
            <Search size={20} color={colors.light.light.light.text} style={styles.searchIcon} />
            <TextInput
      ...
      >
        ...
        {destination && (
          <Marker
            ...
            pinColor={colors.light.light.light.accent}
          >
...
const styles = StyleSheet.create({
  ...
  destinationMarker: {
    ...
    height: 40,
    borderRadius: 20,
    backgroundColor: colors.light.light.light.accent,
    justifyContent: 'center',
    alignItems: 'center',
    borderWidth: 2,
    borderColor: 'white',
